...
@lexer::header {
package iit.dsl.coord.parser.antlr.internal;
...
import iit.dsl.coord.services.CoordTransDslGrammarAccess;

}

@parser::members {

 	private CoordTransDslGrammarAccess grammarAccess;

    public InternalCoordTransDslParser(TokenStream input, CoordTransDslGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected CoordTransDslGrammarAccess getGrammarAccess() {
...
@after {
	...
	(
			...
			(
				...
				lv_paramGroups_3_0=ruleParametersDeclaration
				{
					...
					add(
						...
						"paramGroups",
						lv_paramGroups_3_0,
						"iit.dsl.coord.CoordTransDsl.ParametersDeclaration");
					afterParserOrEnumRuleCall();
				}
			)
		)*
		otherlv_4='TransformedFramePos'
		{
			newLeafNode(otherlv_4, grammarAccess.getModelAccess().getTransformedFramePosKeyword_4());
		}
		otherlv_5='='
		{
		...
		(
			(
				(
					lv_convention_6_1='left'
					{
						newLeafNode(lv_convention_6_1, grammarAccess.getModelAccess().getConventionLeftKeyword_6_0_0());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getModelRule());
					    ...
					    |
					lv_convention_6_2='right'
					{
						newLeafNode(lv_convention_6_2, grammarAccess.getModelAccess().getConventionRightKeyword_6_0_1());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getModelRule());
		...
		(
			(
				{
					newCompositeNode(grammarAccess.getModelAccess().getTransformsTransformParserRuleCall_7_0());
				}
				lv_transforms_7_0=ruleTransform
				{
					if ($current==null) {
						$current = createModelElementForParent(grammarAccess.getModelRule());
					}
					add(
						...
						"transforms",
						lv_transforms_7_0,
						"iit.dsl.coord.CoordTransDsl.Transform");
					afterParserOrEnumRuleCall();
				}
			)
		)*
